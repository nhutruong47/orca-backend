...
const pricingPlans = [
  {
    name: 'Starter',
    price: '0đ',
    note: 'Cho đội nhỏ muốn thử quy trình',
    features: ['3 người dùng', '20 đơn hàng/tháng', 'Theo dõi batch cơ bản']
  },
  {
    name: 'Growth',
    price: '499K',
    note: 'Cho xưởng đang tăng đơn',
    features: ['15 người dùng', 'Không giới hạn đơn', 'QC, workflow, báo cáo']
  },
  {
    name: 'Enterprise',
    price: 'Liên hệ',
    note: 'Cho mạng lưới nhiều xưởng',
    features: ['Phân quyền nâng cao', 'Tích hợp riêng', 'Hỗ trợ triển khai']
  }
];
