...
function shouldHideAiPreviewContent(message: Pick<ChatMessage, 'role' | 'content' | 'result'>) {
    if (message.role !== 'assistant' || message.result?.needsClarification) return false;
    if (message.result) return true;

    const text = (message.content || '').toLowerCase();
    return text.includes('roadmap')
        || text.includes('bảng roadmap')
        || text.includes('bang roadmap')
        || text.includes('báº£ng roadmap')
        || (text.includes('stt') && (text.includes('công việc') || text.includes('cÃ´ng viá»‡c')));
}
...
export default function CreateTaskPage() {
            ...
            if (tid) {
                ...
                if (saved) {
                    return JSON.parse(saved).map((m: any) => ({
                        ...m,
                        content: shouldHideAiPreviewContent(m) ? '' : m.content,
    ...
    const handleSend = async () => {
        ...
        try {
            ...
            const aiMsg: ChatMessage = {
                ...
                role: 'assistant',
                content: res.needsClarification
                    ? (res.description || 'Tôi cần thêm thông tin để hoàn thiện kế hoạch.')
                    : '',
                result: res,
                timestamp: new Date()
            };
                            ...
                            {messages.map(msg => (
                                <div key={msg.id} className={`task-gpt-message-row ${msg.role}`}>
                                    <article className="task-gpt-bubble">
                                        ...
                                        {!shouldHideAiPreviewContent(msg) && (
    ...
    return (
        <>
        <style>{`
            body.theme-dark .layout .ai-result-refinement,
            body.theme-dark .layout .ai-result-refinement__header,
            body.theme-dark .layout .ai-result-refinement__body,
            body.theme-dark .layout .ai-result-refinement__section,
            .ai-result-refinement,
            .ai-result-refinement__header,
            .ai-result-refinement__body,
            .ai-result-refinement__section {
                background: #ffffff !important;
                color: #1e293b !important;
            }
            body.theme-dark .layout .ai-result-refinement input,
            .ai-result-refinement input {
                background: #ffffff !important;
                color: #1e293b !important;
                border-color: #e2e8f0 !important;
            }
            body.theme-dark .layout .ai-result-refinement label,
            body.theme-dark .layout .ai-result-refinement h2,
            body.theme-dark .layout .ai-result-refinement h3,
            body.theme-dark .layout .ai-result-refinement p,
            .ai-result-refinement label,
            .ai-result-refinement h2,
            .ai-result-refinement h3,
            .ai-result-refinement p {
                color: inherit !important;
                -webkit-text-fill-color: currentColor !important;
            }
        `}</style>
        <div className="ai-result-refinement" style={{
            minHeight: '100vh',
                            ...
                            messages.map((msg) => (
                                <div key={msg.id} style={{
                                    ...
                                    {msg.role === 'user' ? (
                                        ...
                                        />
                                    ) : shouldHideAiPreviewContent(msg) ? null : (
 ...
 */
function AiResultRefinementForm({
    result,
    onConfirm,
    onCancel,
    onAsk
    ...
    return (
        ...
        <style>{`
            ...
            .ai-result-refinement {
                ...
                color: #4b2f16 !important;
                border-color: #ead6b5 !important;
            }
            body.theme-dark .layout .ai-result-refinement__header,
            .ai-result-refinement__header {
            ...
            .ai-result-refinement p {
                color: #4b2f16 !important;
                -webkit-text-fill-color: #4b2f16 !important;
            }
            body.theme-dark .layout .ai-result-refinement input,
            .ai-result-refinement input {
                ...
                border-color: #e8d2aa !important;
                -webkit-text-fill-color: #2f1d0c !important;
            }
            body.theme-dark .layout .ai-result-refinement [style*="background: #fff"],
            body.theme-dark .layout .ai-result-refinement [style*="background: rgb(255, 255, 255)"],
            body.theme-dark .layout .ai-result-refinement [style*="background: transparent"],
            .ai-result-refinement [style*="background: #fff"],
            .ai-result-refinement [style*="background: rgb(255, 255, 255)"],
            .ai-result-refinement [style*="background: transparent"] {
                background-color: #fffaf0 !important;
                color: #4b2f16 !important;
                border-color: #e8d2aa !important;
            }
            body.theme-dark .layout .ai-result-refinement__add,
            .ai-result-refinement__add {
                background-color: #fff1c7 !important;
                color: #8a5200 !important;
                border-color: #f0d28f !important;
            }
            body.theme-dark .layout .ai-result-refinement__priority,
            .ai-result-refinement__priority {
                background-color: #fffaf0 !important;
                border-color: #e8d2aa !important;
            }
        `}</style>
        <div className="ai-result-refinement" style={{
            ...
            {/* Header Area */}
            <div className="ai-result-refinement__header" style={{ padding: '24px 32px', borderBottom: '1px solid #f1f5f9', position: 'relative', background: '#ffffff' }}>
            ...
            <div className="ai-result-refinement__body" style={{ padding: '32px' }}>
                {/* Standardization Card */}
                <div className="ai-result-refinement__section" style={{ background: '#ffffff', borderRadius: '16px', border: '1px solid #f1f5f9', padding: '24px' }}>
                    ...
                    <div style={{ marginBottom: 24 }}>
                        ...
                        <div style={{ display: 'flex', flexDirection: 'column', gap: 12 }}>
                            ...
                            <button
                                className="ai-result-refinement__add"
                                onClick={addTask}
                                style={{
                    ...
                    <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: 24 }}>
                        ...
                        <div>
                            ...
                            <div className="ai-result-refinement__priority" style={{ display: 'flex', borderRadius: '12px', border: '1px solid #e2e8f0', overflow: 'hidden', background: '#fff' }}>
